...
.org 0x0034
begin: CLI ;Clear Interrupt, Set registervalue to 0
	LDI R16,low(RAMEND);load low byte of RAMEND into R16
	OUT SPL,R16;store R16 in stack pointer low
	LDI R16,high(RAMEND) ;load low byte of RAMEND into R16
